...
public class FcyTxnFlagUD {
    ...
    public String toString() {
        return "FcyTxnFlagUD{" + "noUd=" + noUd + ", ccyUd=" + ccyUd + ", amtLimit=" + amtLimit + ", amtAvail=" + amtAvail + ", cdBranch=" + cdBranch + ", dtExpiry=" + dtExpiry + ", noCif=" + noCif + ", amtTxn=" + amtTxn + '}';
    }
