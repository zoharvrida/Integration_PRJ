...
public class SknNgInwardDebitBulkService extends SknNgDebitBulkService {
	...
	public String getResultOfRequestInwardWSToSPK(String BIC) {
		return (new SknNgWSProcessInwardDebitBulk(BIC).requestInwardWSToSPK());
	}

	
	
	protected class SknNgWSProcessInwardDebitBulk extends SknNgInwardWSProcess {
		public SknNgWSProcessInwardDebitBulk(String BIC) {
			super(BIC);
		}
