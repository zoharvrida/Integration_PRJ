...
public class FixSchedulerXtractDao extends BaseDao {
    ...
    public List<FixSchedulerXtract> getAllXtractSchedule(int size){
        return getAllXtractSchedule(size, "");
    }
    public List<FixSchedulerXtract> getAllXtractSchedule(int size, String typeDest) {
        ...
        if(!"".equalsIgnoreCase(typeDest)){
            sb.append("and lower(typDest) = :typDest ");
        } else {
            sb.append("and lower(typDest) NOT LIKE 'email' ");
        }
        Query query = getSession().createQuery(sb.toString());
        ...
        if(!"".equalsIgnoreCase(typeDest)){
            query.setString("typDest", typeDest);
        }
