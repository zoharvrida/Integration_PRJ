...
public class EncryptionUtil {
     ...
     * @throws InvalidAlgorithmParameterException
     */
    protected static void DESAlgo(String source, String dest, String key, int mode) throws IOException, InvalidKeyException, NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, FileNotFoundException, InvalidAlgorithmParameterException {
        byte[] fileContent = null;
        FileInputStream fis = new FileInputStream(source);
        try {
    ...
    protected static String ZIPdecompress(String source, String dest, String password) throws ZipException, IOException {
        ...
        if (password != null) {
            ...
            zipFile.setPassword(password);
                ...
                throw new ZipException("Zip file '" + FilenameUtils.getName(source) + "' doesn't have Password Encrypted!!!");
        }
