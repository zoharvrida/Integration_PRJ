...
public class Dialog23203Action extends BaseDialogAction {

    private static final String SKN_NG_SMO_DEBIT = "SknNgSMODebit_list.action";
    ...
    public String getListType() {
        try {
            this.getLogger().debug("dropdown Mode : " + this.getModes());
            this.getLogger().debug("Mode : " + this.getMode());
            doList();
            this.getLogger().info(getGrpiDList());
        } catch (Exception ex) {
            Logger.getLogger(Dialog23203Action.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public List doList() throws Exception {
        ...
        this.getLogger().debug("Mode : " + this.getMode());
        this.getLogger().debug("cdBranch : " + this.getCdBranch());
        ...
        String result = HttpUtil.request(getBdsmHost() + SKN_NG_SMO_DEBIT, params);
