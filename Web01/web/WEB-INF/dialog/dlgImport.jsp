...
<s:url var="urlGrid" action="13301I_list" namespace="/json">
...
>
    ...
    <sjg:gridColumn name="fixSchedulerPK.namScheduler" index="fixSchedulerPK.namScheduler" title="scheduler Name" sortable="false"/>
