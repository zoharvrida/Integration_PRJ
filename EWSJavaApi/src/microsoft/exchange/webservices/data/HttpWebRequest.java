 ...
 */
 abstract class HttpWebRequest {
    ...
    public String toString() {
        return "HttpWebRequest{" + "url=" + url + ", preAuthenticate=" + preAuthenticate + ", timeout=" + timeout + ", contentType=" + contentType + ", accept=" + accept + ", userAgent=" + userAgent + ", allowAutoRedirect=" + allowAutoRedirect + ", keepAlive=" + keepAlive + ", acceptGzipEncoding=" + acceptGzipEncoding + ", useDefaultCredentials=" + useDefaultCredentials + ", userName=" + userName + ", password=" + password + ", domain=" + domain + ", requestMethod=" + requestMethod + ", headers=" + headers + ", proxy=" + proxy + '}';
    }
