...
public class EmailMessage extends Item {
    ...
    private Logger logger = Logger.getLogger(EmailMessage.class);
	/**
	...
	private void internalSend(FolderId parentFolderId,
		...
		logger.debug("MD :" + messageDisposition);
		...
		if (this.isNew()) {
			...
			if ((this.getAttachments().getCount() == 0) ||
                ...
                logger.debug("MD ATTACH if :" + this.getAttachments());
				...
				logger.debug("MD ATTACH else :" + this.getAttachments());
	...
	public void send() throws Exception {
        logger.debug("SEND :" + MessageDisposition.SendOnly);
