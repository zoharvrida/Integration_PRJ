...
<s:url var="urlGrid" action="20402UD_list" namespace="/json" escapeAmp="false">
...
>
    ...
    <sjg:gridColumn name="AMTLIMIT" index="AMTLIMIT" title="Amount Limit" sortable="true" align="right" formatter="currency"/>
    <sjg:gridColumn name="AMTAVAIL" index="AMTAVAIL" title="Available Limit" sortable="true" align="right" formatter="currency" hidden="true"/>
    <sjg:gridColumn name="AMTLIMITUSD" index="AMTLIMITUSD" title="Amount Limit USD" sortable="true" align="right" formatter="currency"/>
    <sjg:gridColumn name="AMTAVAILUSD" index="AMTAVAILUSD" title="Available Limit USD" sortable="true" align="right" formatter="currency"/>
