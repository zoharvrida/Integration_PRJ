 ...
 * @author bdsm
 */
public class Menu23202Action extends BaseContentAction {
    ...
    public String doAdd() {
		...
		try {
			...
			Logger.getLogger(Menu23202Action.class.getName()).log(Level.SEVERE, null, ex);
		}
