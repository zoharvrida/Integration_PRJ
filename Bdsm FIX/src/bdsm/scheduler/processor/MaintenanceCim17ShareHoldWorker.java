...
import bdsm.scheduler.dao.TmpMaintenanceCim17ShareHoldDao;
...
import bdsm.scheduler.model.TmpMaintenanceCim17ShareHoldPK;
 ...
 * @author v00020800
 */
public class MaintenanceCim17ShareHoldWorker extends BaseProcessor {
     ...
     * @param context
     */
    public MaintenanceCim17ShareHoldWorker(Map context) {
        super(context);
    }
    ...
    protected boolean doExecute() throws Exception {
        String configFile;
        configFile = "excelutil_cim17ShareHold.properties";
        ...
        TmpMaintenanceCim17ShareHoldDao maintenanceCifCim17Dao = new TmpMaintenanceCim17ShareHoldDao(session);
        ...
        if (status.equals(StatusDefinition.UNAUTHORIZED)) {
            ...
            this.readExcel(param5, configFile, maintenanceCifCim17Dao); //Must Change
            this.session.flush();
            this.getLogger().info("Import Excel file from Requestor Success");
            maintenanceCifCim17Dao.runValidate(batchNo);
            ...
            maintenanceCifCim17Dao.runProcess(batchNo);
            ...
            maintenanceCifCim17Dao.runReject(batchNo);
            fixQXtract = new FixQXtract();
    ...
    private void readExcel(String param5, String configFile, TmpMaintenanceCim17ShareHoldDao maintenanceCifDao) throws FileNotFoundException, IOException, InvalidFormatException, OpenXML4JException, SAXException, ParserConfigurationException, ParseException {
    ...
    private void readXLS(String param5, String configFile, TmpMaintenanceCim17ShareHoldDao maintenanceCifDao) throws FileNotFoundException, IOException, InvalidFormatException, OpenXML4JException, SAXException, ParserConfigurationException {
        XLSReader xr = XLSReader.getInstance(param5, configFile);
        TmpMaintenanceCim17ShareHold tmpMaintenanceCif;
        TmpMaintenanceCim17ShareHoldPK tmpMaintenanceCifPK;
        String[] propertyNames = {"compositeId.cif","namMajShareHldr1","namMajShareHldr2","namMajShareHldr3","namMajShareHldr4","namMajShareHldr5","namMajShareHldr6","namMajShareHldr7",
            "namMajShareHldr8", "namMajShareHldr9", "namMajShareHldr10", "relationShip1", "relationShip2", "relationShip3", "relationShip4", "relationShip5", "relationShip6", "relationShip7", "relationShip8", "relationShip9", "relationShip10"};
        Integer recordId = 0;
        while (xr.hasNextRow()) {
            recordId += 1;
            tmpMaintenanceCifPK = new TmpMaintenanceCim17ShareHoldPK();
            tmpMaintenanceCifPK.setBatchiId(context.get(MapKey.batchNo).toString());
            tmpMaintenanceCifPK.setRecordId(recordId);
            tmpMaintenanceCif = new TmpMaintenanceCim17ShareHold();
            tmpMaintenanceCif.setFlagStatus(StatusDefinition.UNAUTHORIZED);
            ...
            try {
                ...
                tmpMaintenanceCif.setFlagStatus(StatusDefinition.REJECTED);
            }
        }
    }

    private void readXLSX(String param5, String configFile, TmpMaintenanceCim17ShareHoldDao maintenanceCifDao) {
