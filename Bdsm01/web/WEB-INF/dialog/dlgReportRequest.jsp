...
<sjg:grid
	...
	<sjg:gridColumn name="REPORTNAME" index="REPORTNAME" title="Report Pattern" sortable="false" width="50" hidden="true"/>
	...
	<sjg:gridColumn name="FLG_AUTH" index="FLG_AUTH" title="flgAuth" sortable="false" width="50" hidden="true"/>
</sjg:grid>
<script type="text/javascript">
    ...
    $(function() {
        ...
        $("#gridtable").subscribe("selectRow", function(event, data) {
            ...
            $("#" + dlgParams.flgAuth).val($(data).jqGrid("getCell", event.originalEvent.id, "FLG_AUTH"));
			//alert("lewat sini??")            
