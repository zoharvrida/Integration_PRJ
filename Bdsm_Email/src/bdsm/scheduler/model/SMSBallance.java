 ...
 * @author v00019722
 */
public class SMSBallance extends BaseModel {
    ...
    public String rearrangeString(String delimiter) {
        ...
        SMS.append(this.cod_cust).append(delimiter).
                ...
                append(this.cod_acct_no==null?"":this.cod_acct_no).append(delimiter).
                ...
                append(this.cod_txn_mnemonic==null?"":this.cod_txn_mnemonic).append(delimiter).
                append(this.cod_txn_literal==null?"":this.cod_txn_literal).append(delimiter).
                append(this.flg_drcr==null?"":this.flg_drcr).append(delimiter).
                append(this.acctccy==null?"":this.acctccy).append(delimiter).
                append(this.amt_acct==null?"":this.amt_acct).append(delimiter).
                append(this.amt_txn_lcy==null?"":this.amt_txn_lcy).append(delimiter).
