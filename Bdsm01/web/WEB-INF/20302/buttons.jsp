...
<script type="text/javascript">
    ...
    */
    ...
    jQuery(document).ready(function() {
        ...
        rdb.setOnChange(
        function() {
            changeAction("frmMain", "20302", "");
            $("#frmMain_noCif").focus();
            $("#frmMain_cdBranch").attr("value", null);
            $("#frmMain_status").attr("value", null);
        },
        function() {
            changeAction("frmMain", "20302", "_add");
            $("#frmMain_noCif").focus();
            $("#btnSave").attr("value", '<s:text name="button.save" />');
            
            if ((msgParams.isOpen == false) && ($("#actionMessage").length == 0)) {
                msgParams.isOpen = true;
                $("#tempformMessage").click();
            }
        },
        function() {
            changeAction("frmMain", "20302", "_edit");
            $("#frmMain_noCif").focus();
            $("#frmMain_cdBranch").attr("value", null);
            $("#frmMain_status").attr("value", null);
        ...
        function() {
            changeAction("frmMain", "20302", "_delete");
            $("#frmMain_noCif").focus();
            $("#frmMain_cdBranch").attr("value", null);
            $("#frmMain_status").attr("value", null);
