...
<div id="approvalGrid" style="overflow-x: auto; display: inline-block;" class=".ui-widget-header">
	<s:form id="frmApproval" action="23201_add" method="post">
	...
	>
		...
		<sjg:gridColumn name="1.compositeId.recordId" title="Record Row No." width="5" align="right" sortable="false" />
		<sjg:gridColumn name="1.batchId" title="Batch ID" width="7" align="center" sortable="false" />
		<sjg:gridColumn name="1.identitasPesertaPengirim" title="Sender ID" width="10" align="left" sortable="false" />
		<sjg:gridColumn name="1.sandiKotaPengirim" title="Sender Sector Code" width="7" align="left" sortable="false" />
		<sjg:gridColumn name="1.jumlahRecords" title="Total Records" width="5" align="right" formatter="integer" sortable="false" />
		<sjg:gridColumn name="1.totalNominal" title="Total Nominal" width="12" align="right" formatter="customCurrency" sortable="false" />
		<sjg:gridColumn name="1.tanggalBatch" title="Batch Date" width="10" align="center" sortable="false" />
	</sjg:grid>
