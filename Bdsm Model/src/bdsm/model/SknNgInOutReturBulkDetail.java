...
public class SknNgInOutReturBulkDetail extends SknNgInOutReturBulkParent implements java.io.Serializable {
	...
	private String nomorUrutTransaksiOriginal;
	...
	public String getNomorUrutTransaksiOriginal() {
		return this.nomorUrutTransaksiOriginal;
	}
	public void setNomorUrutTransaksiOriginal(String nomorUrutTransaksiOriginal) {
		this.nomorUrutTransaksiOriginal = nomorUrutTransaksiOriginal;
	}
	...
	public String toString() {
		StringBuilder sb = new StringBuilder(this.getClass().getSimpleName())
			...
			.append(",alasanPenolakan=").append(this.alasanPenolakan)
			.append(",nomorUrutTransaksiOriginal=").append(this.nomorUrutTransaksiOriginal)
