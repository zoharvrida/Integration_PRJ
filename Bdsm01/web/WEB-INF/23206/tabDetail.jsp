...
<script>
	...
	function elementPublisherSector(elem) {
		$(elem).attr('name', 'data.sandiKotaPenerbit');
...
<div id="detailGrid" class=".ui-widget-header">
	...
	<s:url var="urlGridEdit" action="23206_editDetail" namespace="/json" escapeAmp="false" />
	...
	>
		...
		<sjg:gridColumn name="1.sandiKotaPenerbit" title="\"Sandi Kota Penerbit\"" width="55" align="center" editable="true"
		...
		<sjg:gridColumn name="1.destCreditAccount" title="Credit Acct." width="110" formatter="trimmer" align="right" />
		<sjg:gridColumn name="1.debitAccount" title="Debit Acct." width="110" formatter="trimmer" align="right" />
		...
		<sjg:gridColumn name="1.nomorWarkat" title="\"No. Warkat\"" width="50" formatter="trimmer" align="center" />
...
<script type="text/javascript">
	jQuery(document).ready(function() {
		...
		$("#detailGridTable").subscribe("detailGridRowDoubleClicked", function(event, data) {
			...
			$elem = $("input[name='data.sandiKotaPenerbit']");
			$elem
			...
			$("#detailGridTable").jqGrid("editGridRow", rowNo, {
				...
				beforeSubmit: function(postData, formId) {
								postData['data.sandiKotaPenerbit'] = ($("#idSectorCode").attr("value") == "" ? $elem.attr("value"): $("#idSectorCode").attr("value"));
								$("#detailGridTable").jqGrid("setCell", $("#detailGridTable").jqGrid("getGridParam", "selrow"), "1.sandiKotaPenerbit", $("#idSectorCode").attr("value"));
								return [true, ''];
							},
