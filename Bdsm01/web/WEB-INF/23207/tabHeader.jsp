...
<div id="headerGrid" style="overflow-x: auto; display: inline-block;" class=".ui-widget-header">
	...
	>
		...
		<sjg:gridColumn name="1.sandiKotaAsal" title="Sender City Code" width="70" align="center" sortable="false" />
...
<script type="text/javascript">
	jQuery(document).ready(function() {
		...
		$("#headerGridTable").subscribe("headerGridRowSelected", function(event, data) {
			...
			$("#frmData_senderCityCode").val(grid.jqGrid("getCell", selectedNo, "1.sandiKotaAsal"));
			...
			if (isHeaderError == false) {
				...
				$("#tabbedPanelDetail").tabs("url", 0, "23207Tab_input.action");
