...
public class Menu23206Action extends bdsm.web.BaseContentAction {
	...
	public String exec() {
		...
		params.put("token", BdsmUtil.generateToken(this.getTokenKey(), this.getTzToken()));
		bdsm.util.HttpUtil.request(this.getBdsmHost() + "SknNgOutwardDebit_callMethod", params);
