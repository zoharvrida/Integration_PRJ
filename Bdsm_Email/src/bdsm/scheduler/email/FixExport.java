...
public class FixExport extends BDSMScheduler2 {
    ...
    protected void execute() {
        ...
        try {
            ...
            List<FixSchedulerXtract> listFixSchedulerXtract = fixSchedulerXtractDao.getAllXtractSchedule(this.maxJob, "email");
            ...
            List<FixQXtract> listFixQXtract = fixQXtractDao.getAllQXtractList(this.maxJob,"email");
