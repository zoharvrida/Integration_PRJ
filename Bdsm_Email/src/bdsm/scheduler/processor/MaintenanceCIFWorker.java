...
import bdsm.scheduler.dao.TmpMaintenanceCifDao;
 ...
 * @author v00020841
 */
public class MaintenanceCIFWorker extends BaseProcessor {
    ...
    private String emailDone = "Dear Sir/Madam,<br/>"
            + "<br/>"
            + "Process maintenance cif  has been processed. <br/>"
    ...
    private String emailRejected = "Dear Sir/Madam,<br/>"
            + "<br/>"
            + "Your requested process to maintenance cif has been Rejected by Supervisor. <br/>"
            + "<br/>"
            + "Thanks & regards,<br/>"
            + "- BDSM -";

    public MaintenanceCIFWorker(Map context) {
        super(context);
    }
    ...
    protected boolean doExecute() throws Exception {
        String configFile;
        configFile = "excelutil_maintenancecif.properties";
        ...
        TmpMaintenanceCifDao maintenanceCifDao = new TmpMaintenanceCifDao(session);
        ...
        if (status.equals(StatusDefinition.UNAUTHORIZED)) {
            ...
            this.readExcel(param5, configFile, maintenanceCifDao); //Must Change
            this.session.flush();
            this.getLogger().info("Import Excel file from Requestor Success");
            maintenanceCifDao.runValidate(batchNo);
            ...
            maintenanceCifDao.runProcess(batchNo);
            ...
            maintenanceCifDao.runReject(batchNo);
            fixQXtract = new FixQXtract();
    ...
    //Must Change
    private void readExcel(String param5, String configFile, TmpMaintenanceCifDao maintenanceCifDao) throws FileNotFoundException, IOException, InvalidFormatException, OpenXML4JException, SAXException, ParserConfigurationException, ParseException {
    ...
    //Must Change
    private void readXLS(String param5, String configFile, TmpMaintenanceCifDao maintenanceCifDao) throws FileNotFoundException, IOException, InvalidFormatException, OpenXML4JException, SAXException, ParserConfigurationException {
        XLSReader xr = XLSReader.getInstance(param5, configFile);
        TmpMaintenanceCif tmpMaintenanceCif;
        TmpMaintenanceCifPK tmpMaintenanceCifPK;
        String[] propertyNames = {"compositeId.cif", "salutation","incomeTaxNo","employeeId","reasonVerifed","address1MA","address2MA","address3MA","cityMA","stateMA","countryMA","postalCodeMA","telexMA","phoneOfficeMA","phoneResMA","faxNoMA",
                                  "emailInternetRA","emailMobileRA","statusIC","signTypIC","ethnicIC","countryResidenIC","sexIC","profesCodeIC","designationIC","nationalityIC","educationIC","maritalStatus","noOfSpouseIC","businesTypeCC",
                                  "typCompanyCC","datRegisteredCC","registrationNoCC","signatoresName1CC","signatoresName2CC","signatoresName3CC","signatoresName4CC","signatoresName5CC","signatoresDesignation1CC","signatoresDesignation2CC",
                                  "signatoresDesignation3CC","signatoresDesignation4CC","signatoresDesignation5CC","dirPartner1CC","dirPartner2CC","dirPartner3CC","dirPartner4CC","dirPartner5CC",
                                  "tenurED","nameED","address1ED","address2ED","address3ED","cityED","stateED","countryED","postalCodeED","mobileED","emailED","phoneED","telexNoED","faxNoED","numOfYearsED","retriementAgeED","parentNamePD","parenticPD",
                                  "occupationPD","designationPD","parentBODPD","spouseDetailPD","address1PD","address2PD","address3PD","phoneNoPD",
                                  "typeCompCO","placeInCorpCO","noPartnerCO","parentCompanyCO","apexHoldingCompany","contactPersonCO","contacPersonDesgnCO","internalCreditRatingCO","businesLicenseNoCO","businesCommencementDateCO","businesLicenseExpiryDateCO",
                                  "bankName1CO","bankName2CO","natureOfBusinesCO","majorShareHolder1","majorShareHolder2","majorShareHolder3","majorShareHolder4","majorShareHolder5","majorShareHolder6","majorShareHolder7","majorShareHolder1","majorShareHolder9",
                                  "majorShareHolder10","relationShip1","relationShip2","relationShip3","relationShip4","relationShip5","relationShip6","relationShip7","relationShip8","relationShip9","relationShip10"};
        Integer recordId = 0;
        while (xr.hasNextRow()) {
            recordId += 1;
            tmpMaintenanceCifPK = new TmpMaintenanceCifPK();
            tmpMaintenanceCifPK.setBatchiId(context.get(MapKey.batchNo).toString());
            tmpMaintenanceCifPK.setRecordId(recordId);
            tmpMaintenanceCif = new TmpMaintenanceCif();
    ...
    //Must Change
    private void readXLSX(String param5, String configFile, TmpMaintenanceCifDao maintenanceCifDao) {
        ...
        String[] propertyNames = {"compositeId.cif","salutation","incomeTaxNo","employeeId","reasonVerifed","address1MA","address2MA","address3MA","cityMA","stateMA","countryMA","postalCodeMA","telexMA","phoneOfficeMA","phoneResMA","faxNoMA",
                                  ...
                                  "typCompanyCC","datRegisteredCC","registrationNoCC","signatoresName1CC","signatoresName2CC","signatoresName3CC","signatoresName4CC","signatoresName5CC","signatoresDesignation1CC","signatoresDesignation2CC",
                                  "signatoresDesignation3CC","signatoresDesignation4CC","signatoresDesignation5CC","dirPartner1CC","dirPartner2CC","dirPartner3CC","dirPartner4CC","dirPartner5CC",
                                  "tenurED","nameED","address1ED","address2ED","address3ED","cityED","stateED","countryED","postalCodeED","mobileED","emailED","phoneED","telexNoED","faxNoED","numOfYearsED","parentNamePD","parenticPD",
                                  "occupationPD","designationPD","parentBODPD","spouseDetailPD","address1PD","address2PD","address3PD","phoneNoPD",
                                  "typeCompCO","placeInCorpCO","noPartnerCO","parentCompanyCO","apexHoldingCompany","contactPersonCO","contacPersonDesgnCO","internalCreditRatingCO","businesLicenseNoCO","businesCommencementDateCO","businesLicenseExpiryDateCO",
                                  "bankName1CO","bankName2CO","natureOfBusinesCO","majorShareHolder1","majorShareHolder2","majorShareHolder3","majorShareHolder4","majorShareHolder5","majorShareHolder6","majorShareHolder7","majorShareHolder1","majorShareHolder9",
                                  "majorShareHolder10","relationShip1","relationShip2","relationShip3","relationShip4","relationShip5","relationShip6","relationShip7","relationShip8","relationShip9","relationShip10"};
