...
public class Menu23207Action extends bdsm.web.BaseContentAction {
	...
	public String doInput() {
		...
		String result = bdsm.util.HttpUtil.request(this.getBdsmHost() + "SknNgOutwardCredit_callMethod", params);
	...
	public String exec() {
		...
		params.put("token", BdsmUtil.generateToken(this.getTokenKey(), this.getTzToken()));
		bdsm.util.HttpUtil.request(this.getBdsmHost() + "SknNgOutwardCredit_callMethod", params);
