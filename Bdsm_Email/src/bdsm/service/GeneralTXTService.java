                        ...
                        if (id.getFieldFormat() != null) {
                            if (id.getFieldType().equalsIgnoreCase("DATE") || id.getFieldType().equalsIgnoreCase("TIMESTAMP")) {
                                ...
                                if (id.getFieldFormatOut() != null) {
                                    fieldName = "to_char(" + fieldName + ",'" + id.getFieldFormatOut() + "')";
                                } else {
                                    fieldName = "to_char(" + fieldName + ",'" + id.getFieldFormat() + "')";
                                }
                    ...
                    if (d != null) {
                        if (d.getType().contains("O")) {
                            if (!d.getType().contains("Q")) {
                                if (im.getDelimiter().equalsIgnoreCase("")) {
                                    String padd = null;
                                    try {
                                    ...
                                    if (d.getMaxLength() != null) {
                                        ...
                                        if (f == ld.size() - 1) {
                                            ...
                                            sb.append(nopadd).append(im.getDelimiter());
                                        }
                                    } else {
                                        String padd = "";
                                        ...
                                        if (f == ld.size() - 1) {
                                            ...
                                            sb.append(padd).append(im.getDelimiter());
                                        }
                                    }
                                    // check format
    ...
    private List fixLtoList(String lineDetails, List<ARParamDetailsInterface> dt) {
        ...
        for (ARParamDetailsInterface d : dt) {
            if (d.getIdOrder().compareTo(1) == 0) {
                ...
                values.add(lineDetails.substring(nextval, d.getMaxLength()));
            }
        }
        return values;
    }
