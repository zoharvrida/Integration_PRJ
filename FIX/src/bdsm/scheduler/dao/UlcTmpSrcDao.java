 ...
 * @author NCBS
 */
public class UlcTmpSrcDao extends BaseDao implements Work {
     ...
     * @param session
     */
    public UlcTmpSrcDao(Session session) {
        super(session);
    }
     ...
     * @return
     */
    public List<UlcTmpSrc> get(String param) {        
    ...
    protected boolean doInsert(BaseModel model) {
        getSession().save((UlcTmpSrc) model);
        return true;
    }
    ...
    protected boolean doUpdate(BaseModel model) {
        getSession().update((UlcTmpSrc) model);
        return true;
    }
    ...
    protected boolean doDelete(BaseModel model) {
        getSession().delete((UlcTmpSrc) model);
        return true;
    }
